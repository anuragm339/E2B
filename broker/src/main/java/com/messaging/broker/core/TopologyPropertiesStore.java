...
public class TopologyPropertiesStore {
     ...
     * @throws MessagingException if saving topology fails
     */
    public void saveTopology(TopologyResponse topology) throws MessagingException {
        ...
        try (FileWriter writer = new FileWriter(propertiesFile.toFile())) {
            ...
            throw ExceptionLogger.logAndThrow(log,
                new MessagingException(ErrorCode.REGISTRY_TOPOLOGY_FETCH_FAILED,
