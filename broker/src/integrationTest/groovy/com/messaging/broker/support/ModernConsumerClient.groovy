...
class ModernConsumerClient implements AutoCloseable {
    ...
    static ModernConsumerClient connect(String host, int port) {
        ...
        new ModernConsumerClient(client, connection, received)
    }
