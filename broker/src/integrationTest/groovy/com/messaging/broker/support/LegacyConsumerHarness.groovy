...
class LegacyConsumerHarness implements AutoCloseable {
    ...
    static LegacyConsumerHarness connect(String host, int port, String serviceName) {
        ...
        def harness = new LegacyConsumerHarness(socket, input, output, serviceName, received, errors, reader, running)
